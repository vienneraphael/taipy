...
data = pd.read_csv('modified_supermarkt_sales_plus_two_years.csv')
...
new_tax = new_unit_prices * new_quantities * 0.7
...
new_dates = np.random.choice(pd.date_range(start='2023-01-01', end='2023-12-31').date, size=num_entries)
...
augmented_data.to_csv('modified_supermarkt_sales_plus_three_years.csv')