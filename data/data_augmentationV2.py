...
new_unit_prices = np.random.uniform(20, 120, size=num_entries)
new_quantities = np.random.randint(10, 20, size=num_entries)
new_tax = new_unit_prices * new_quantities * 1.6
...
new_ratings = np.random.uniform(5, 20, size=num_entries)
new_dates = np.random.choice(pd.date_range(start='2022-01-01', end='2022-12-31').date, size=num_entries)
...
augmented_data.to_csv('modified_supermarkt_sales_plus_two_years.csv')